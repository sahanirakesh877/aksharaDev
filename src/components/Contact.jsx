  ...
  return (
    <>
      <div className="container  bg-body-secondary">
       ...
       <h2 className="  fw-semibold border-bottom-title text-success text-center  mb-5">Contact Us</h2>

         <div className="col-md-6  contact-left  ">
           <p>If you have any questions, feel free to reach out to us via the form below or through any of the contact methods listed.</p>
           <form>
             <div className="form-group pb-2 ">
               <label htmlFor="name" className="pb-1 ">Name</label>
               <input type="text" className="form-control pb-2 rounded-1  " id="name" placeholder="Your Name" />
             </div>
             <div className="form-group pb-2">
               <label htmlFor="email" className="pb-1">Email</label>
               <input type="email" className="form-control rounded-1  pb-2" id="email" placeholder="Your Email" />
             </div>
             <div className="form-group pb-2">
               <label htmlFor="number" className="pb-1">Phone</label>
               <input type="number" className="form-control rounded-1 pb-2 " id="number" placeholder="Your Phone " />
             </div>
             <div className="form-group pb-2">
               <label htmlFor="message" className="pb-1">Message</label>
               <textarea className="form-control" id="message" rows="5" placeholder="Your Message"></textarea>
             </div>
             <button type="submit" className="border-0 py-2 mb-3 rounded-1 bg-danger text-white w-100">Submit</button>
           </form>
         
         </div>
         <div className="col-md-6  ">
           
           <div className="map-container" style={{ position: 'relative', paddingBottom: '62.90%', height: 0 }}>
             <iframe
       ...
       <div className="contact-info  contact-right pb-4 my-md-0 ">
            ...
            <div className="mb-3">
              ...
              <p className="d-inline ml-2">Kandaghari, Kageshwori Manohara 9, Kathmandu, Nepal</p>
            </div>
          </div>
     </div>
   </div>
