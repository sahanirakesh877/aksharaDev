...
const Contact = () => {
  return (
    <>
      <div className="container py-4 bg-body-secondary">
       <div className="row d-flex align-items-center">
         <div className="col-md-6">
           ...
           <form>
             <div className="form-group pb-2">
               ...
               <input type="text" className="form-control pb-2 rounded-0 " id="name" placeholder="Your Name" />
             </div>
             <div className="form-group pb-2">
               <label htmlFor="email" className="pb-1">Email</label>
               <input type="email" className="form-control rounded-0  pb-2" id="email" placeholder="Your Email" />
             </div>
             <div className="form-group pb-2">
               <label htmlFor="number" className="pb-1">Phone</label>
               <input type="number" className="form-control rounded-0 pb-2 " id="number" placeholder="Your Phone " />
             </div>
             <div className="form-group pb-2">
         ...
         <div className="col-md-6">
           <h2 className="py-md-2 py-4">Our Location</h2>
