        ...
        <div className="container">
          <div className="row  d-flex align-items-center justify-content-between fuche-sec">
            ...
            <h5>Aksharaa‘s Guiding Principle</h5>
              ...
              Our guiding concept at Aksharaa School is "संस्कारयुक्त शिक्षा" which translates education infused with values. We consider the entire development of a child's character and values to be an integral part of meaningful education, which goes beyond academic achievement. In addition to fostering academic development, our curriculum aims at cultivating values like respect, integrity, compassion, and responsibility. Through the incorporation of these principles into our regular teaching procedures, we aspire to develop full-fledged individuals who are not just knowledgeable but also morally and socially conscious.              </p>
            ...
            {activeSection === "senior" && (
              <div className="col-md-4">
                ...
                <h3 className="border-bottom-title w-100 text-center "> Senior School (Class 8-10)</h3>
                <p className="lrpa-text px-2">
                Our Senior School program combines rigorous academics with value-based education, ensuring students are well-prepared for higher education and life’s challenges. Counseling and support services are available to guide students through their.Display of handmade crafts and DIY projects created by our students. Local & natural materials are used for creating these crafts.
                </p>
                <button
                  className="button-21"
                  role="button"
            ...
            {activeSection === "middle" && (
              <div className="col-md-4">
                ...
                <h3 className="border-bottom-title w-100 text-center"> Middle School (Class 6-7)</h3>
                <p className="lrpa-text px-2">
            ...
            {activeSection === "elementary" && (
              <div className="col-md-4">
                ...
                <h3 className="border-bottom-title w-100 text-center">  Elementary School (Class 1-5)</h3>
                <p className="lrpa-text px-2">
            ...
            {activeSection === "kindergarten" && (
              <div className="col-md-4">
                ...
                <h3 className="border-bottom-title w-100 text-center">  Kindergarten (PG-KG)</h3>
                <p className="lrpa-text px-2">
